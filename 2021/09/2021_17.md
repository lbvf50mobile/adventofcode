...
Here needs to generate a `matrix`, check its correctness. Create variables for bounds and a method that returns the sum.

## Task 2.

- Mark all minimum points. Or better create an array of starting points locations.
- Starting from minimum points, implement BFS.
- Save in size of BFS sum and starting_points.
- Sort and select tree last starting points pools sizes and multiply them, return an answer.
